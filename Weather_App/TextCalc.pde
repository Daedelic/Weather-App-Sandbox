...
String title, quit;
float currentTempEdm, currentTempBerlin, currentTempMoscow;
String nameEdm, nameBer, nameMos;

void textSetup() {
  titleFont = createFont ("broadway", height);
  title = "Noah did all the work weather app";
